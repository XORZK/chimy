...
- [comparators.h](/src/comparators.h): for sorting and comparisons of generic structures (BSTs, AVLs, generic lists), we need generic comparators which are organized in this header.
